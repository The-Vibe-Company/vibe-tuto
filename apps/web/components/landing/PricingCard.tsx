...
const features = [
  "Tutoriels illimités",
  "Génération IA des instructions",
  "Captures d'écran HD",
  "Partage en 1 clic",
  "Export PDF & Notion",
  "Support prioritaire",
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-violet-500 bg-white p-8 shadow-xl shadow-violet-100">
            ...
            <div className="mb-6">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-lg text-stone-400 line-through">29€/mois</span>
              </div>
              <p className="mt-2 text-sm text-stone-500">Gratuit pendant la beta</p>
            </div>
            ...
            <div className="mb-6">
              <div className="mb-2 flex items-center justify-between text-sm">
                <span className="text-stone-500">{spotsTaken} places prises</span>
                <span className="font-semibold text-violet-600">Plus que {spotsLeft} !</span>
              </div>
